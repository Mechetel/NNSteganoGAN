...
from steganogan_neural_crypto.decoders import BasicDecoder, DenseDecoder
from steganogan_neural_crypto.encoders import BasicEncoder, ResidualEncoder, DenseEncoder
from steganogan_neural_crypto.loader import DataLoader


def main():
    torch.manual_seed(42)
    training_type = 'custom_neural_crypto'
