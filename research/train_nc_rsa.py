...
from steganogan_nc_rsa.decoders import BasicDecoder, DenseDecoder
from steganogan_nc_rsa.encoders import BasicEncoder, ResidualEncoder, DenseEncoder
from steganogan_nc_rsa.loader import DataLoader


def main():
    torch.manual_seed(42)
    training_type = 'no_critic_with_rsa'
