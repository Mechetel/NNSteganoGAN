...
class BasicEncoder(nn.Module):
    ...
    def _build_layers(self):
        ...
        # Processing layers
        self.layer1_conv = nn.Conv2d(32 + self.data_depth + self.password_depth, 32, kernel_size=3, padding=1)
    ...
    def forward(self, image, data, password):
        # Feature extraction
        ...
        x = torch.cat([x, data, password], dim=1)
...
class DenseEncoder(nn.Module):
    ...
    def _build_layers(self):
        ...
        self.conv2 = nn.Conv2d(32 + self.data_depth + self.password_depth, 32, kernel_size=3, padding=1)
        self.bn2 = nn.BatchNorm2d(32)

        # Third convolution block (dense connection)
        self.conv3 = nn.Conv2d(64 + self.data_depth + self.password_depth, 32, kernel_size=3, padding=1)
        self.bn3 = nn.BatchNorm2d(32)

        # Output convolution
        self.conv4 = nn.Conv2d(96 + self.data_depth + self.password_depth, 3, kernel_size=3, padding=1)
